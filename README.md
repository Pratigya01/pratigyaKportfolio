...
<head>
  ...
  <title>Pratigya Koirala Portfolio</title>
  <style>
    body {
      font-family: "Calibri", sans-serif;
      background: linear-gradient(135deg, #fdf6f0 60%, #f7ebe8);
      color: #333;
      line-height: 1.6;
      margin: 0;
      padding: 0;
    ...
    header {
      ...
      box-shadow: 0 4px 6px rgba(90, 62, 43, 0.1);
      position: relative;
    }
    h1 {
    ...
    .section-title {
      ...
      margin-bottom: 1rem;
      color: #5a3e2b;
      border-bottom: 2px dashed #d4c4b4;
